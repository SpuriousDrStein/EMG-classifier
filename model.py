...
# MODEL
#   PLACEHOLDERs
wm = processer(z_chan, depth=5, input_size=batch_size)
...
prediction = wm.fully_connected(z, h_layer_sizes=(z_chan*NUM_CHANNELS, int((z_chan*NUM_CHANNELS)/2), int((z_chan*NUM_CHANNELS)/4), int((z_chan*NUM_CHANNELS)/6), int((z_chan*NUM_CHANNELS)/8) ,num_actions))
